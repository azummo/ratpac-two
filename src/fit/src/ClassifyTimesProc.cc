...
void ClassifyTimesProc::BeginOfRun(DS::Run *run) {
  ...
  if (!WasSet("numer_time_resid_low")) fNumerTimeResLow = table->GetD("numer_time_resid_low");
  if (!WasSet("numer_time_resid_up")) fNumerTimeResUp = table->GetD("numer_time_resid_up");
